...
public:
     ...
     */
    void handleObjectPosition(const slms_interface::msg::ObjectPosition::SharedPtr msg);
...
private:
    ...
    rclcpp::Publisher<slms_interface::msg::AxisStatus>::SharedPtr axis_status_pub_;  ///< 运动状态发布者
    rclcpp::Subscription<slms_interface::msg::ObjectPosition>::SharedPtr object_position_sub_;  ///< 目标位置订阅者
